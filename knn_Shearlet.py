...
print(report)
with open('C:/Users/jemho/Documents/Etude/hambourg/cours_hambourg/intelligent system in medicin/pbl/ISM_ML_Project/Report_knn_Shearlet.txt','w',encoding='utf-8') as f:
    f.write(report)
