...
X_train_gray_wavelet_average_LH = X_train_gray_wavelet_average[:,0]
X_train_gray_wavelet_average_HL = X_train_gray_wavelet_average[:,1]
X_train_gray_wavelet_average_HH = X_train_gray_wavelet_average[:,2]
...
X_train_gray_wavelet_energy_LH = X_train_gray_wavelet_energy[:,0]
X_train_gray_wavelet_energy_HL = X_train_gray_wavelet_energy[:,1]
X_train_gray_wavelet_energy_HH = X_train_gray_wavelet_energy[:,2]
...
X_train_gray_wavelet_entropy_LH = X_train_gray_wavelet_entropy[:,0]
X_train_gray_wavelet_entropy_HL = X_train_gray_wavelet_entropy[:,1]
X_train_gray_wavelet_entropy_HH = X_train_gray_wavelet_entropy[:,2]
...
X_train_gray_wavelet_rms_LH = X_train_gray_wavelet_rms[:,0]
X_train_gray_wavelet_rms_HL = X_train_gray_wavelet_rms[:,1]
X_train_gray_wavelet_rms_HH = X_train_gray_wavelet_rms[:,2]
...
X_train_gray_wavelet_kurtosis_LH = X_train_gray_wavelet_kurtosis[:,0]
X_train_gray_wavelet_kurtosis_HL = X_train_gray_wavelet_kurtosis[:,1]
X_train_gray_wavelet_kurtosis_HH = X_train_gray_wavelet_kurtosis[:,2]
...
X_train_gray_wavelet_skewness_LH = X_train_gray_wavelet_skewness[:,0]
X_train_gray_wavelet_skewness_HL = X_train_gray_wavelet_skewness[:,1]
X_train_gray_wavelet_skewness_HH = X_train_gray_wavelet_skewness[:,2]
...
X_train_gray_wavelet_std_LH = X_train_gray_wavelet_std[:,0]
X_train_gray_wavelet_std_HL = X_train_gray_wavelet_std[:,1]
X_train_gray_wavelet_std_HH = X_train_gray_wavelet_std[:,2]

Y_train = np.load(
    "C:/Users/jemho/Documents/Etude/hambourg/cours_hambourg/intelligent system in medicin/pbl/Feature Vectors/y_train.npy")
print(X_train_gray_wavelet_average.shape)
print(X_train_gray_wavelet_rms_HH.shape)
...
X_ver_gray_wavelet_average_LH = X_ver_gray_wavelet_average[:,0]
X_ver_gray_wavelet_average_HL = X_ver_gray_wavelet_average[:,1]
X_ver_gray_wavelet_average_HH = X_ver_gray_wavelet_average[:,2]
...
X_ver_gray_wavelet_energy_LH = X_ver_gray_wavelet_energy[:,0]
X_ver_gray_wavelet_energy_HL = X_ver_gray_wavelet_energy[:,1]
X_ver_gray_wavelet_energy_HH = X_ver_gray_wavelet_energy[:,2]
...
X_ver_gray_wavelet_entropy_LH = X_ver_gray_wavelet_entropy[:,0]
X_ver_gray_wavelet_entropy_HL = X_ver_gray_wavelet_entropy[:,1]
X_ver_gray_wavelet_entropy_HH = X_ver_gray_wavelet_entropy[:,2]
...
X_ver_gray_wavelet_rms_LH = X_ver_gray_wavelet_rms[:,0]
X_ver_gray_wavelet_rms_HL = X_ver_gray_wavelet_rms[:,1]
X_ver_gray_wavelet_rms_HH = X_ver_gray_wavelet_rms[:,2]
...
X_ver_gray_wavelet_kurtosis_LH = X_ver_gray_wavelet_kurtosis[:,0]
X_ver_gray_wavelet_kurtosis_HL = X_ver_gray_wavelet_kurtosis[:,1]
X_ver_gray_wavelet_kurtosis_HH = X_ver_gray_wavelet_kurtosis[:,2]
...
X_ver_gray_wavelet_skewness_LH = X_ver_gray_wavelet_skewness[:,0]
X_ver_gray_wavelet_skewness_HL = X_ver_gray_wavelet_skewness[:,1]
X_ver_gray_wavelet_skewness_HH = X_ver_gray_wavelet_skewness[:,2]
...
X_ver_gray_wavelet_std_LH = X_ver_gray_wavelet_std[:,0]
X_ver_gray_wavelet_std_HL = X_ver_gray_wavelet_std[:,1]
X_ver_gray_wavelet_std_HH = X_ver_gray_wavelet_std[:,2]
