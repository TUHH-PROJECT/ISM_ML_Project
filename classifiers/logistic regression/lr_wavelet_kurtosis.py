...
x_train = np.load("/Users/apoorv/PycharmProjects/ISM_ML_Project/Features/wavelet/training vectors/X_train_gray_wavelet_kurtosis_combined.npy")
x_test = np.load("/Users/apoorv/PycharmProjects/ISM_ML_Project/Features/wavelet/test vectors/X_ver_gray_wavelet_kurtosis_combined.npy")
